...
D_rev2016 <- readxl::read_excel(here("DATA_Raw", "BASE_TD_FILO_DEC_IRIS_2016.xls"), skip = 4)
...
#2018
```{r}
D_rev2018 <- readxl::read_excel(here("DATA_Raw" , "BASE_TD_FILO_DEC_IRIS_2018.xlsx"), skip = 4)
names(D_rev2018)
...
library(here)
library(readr)
D_rev2020 <- readxl::read_excel(here("DATA_Raw", "BASE_TD_FILO_DEC_IRIS_2020.xlsx"), skip = 4)
...
#2021
```{r}
D_rev2021 <- readxl::read_excel(here("DATA_Raw" , "BASE_TD_FILO_IRIS_2021_DEC.xlsx"), skip = 4)
names(D_rev2021)
...
```{r}
library(data.table)
table_passage <- fread("C:/Users/matei/Desktop/ParisGentrificationDM/Paris-Gentrification-ProjectDM/DATA/table_passage_1999_2022.csv")
...
filo_final <- dplyr::bind_rows(filo2015, filo2016, filo2018, filo2020, filo2021)
...
```
```{r}
write.csv(filo_final, "C:/Users/matei/Desktop/ParisGentrificationDM/Paris-Gentrification-ProjectDM/data_git/filo_final.csv", row.names=FALSE)
